...
//    test3("test_lazyZip", _.lazyZip(_).lazyZip(_).toList)(_.lazyZip(_, _))(_.lazyZip(_).lazyZip(_).toList),
  ...
  val tests: List[test] = tests0 ::: tests1 ::: tests2 ::: tests3
