...
class ReduceIntBenchmark extends IntInputs {
  ...
  @Benchmark def kyochunk_reduce(): Int = kyoChunkInput.reduce(_ + _)
  ...
  @Benchmark def kyochunk_reduceLeft(): Int = kyoChunkInput.reduceLeft(_ + _)
  ...
  @Benchmark def kyochunk_reduceRight(): Int = kyoChunkInput.reduceRight(_ + _)
  ...
  @Benchmark def kyochunk_reduceOption(): Option[Int] = kyoChunkInput.reduceOption(_ + _)
  ...
  @Benchmark def kyochunk_reduceLeftOption(): Option[Int] = kyoChunkInput.reduceLeftOption(_ + _)
  ...
  @Benchmark def kyochunk_reduceRightOption(): Option[Int] = kyoChunkInput.reduceRightOption(_ + _)
