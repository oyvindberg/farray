...
// reduce family. FArray exposes reduce / reduceLeft / reduceRight / reduceOption, but NOT
// reduceLeftOption / reduceRightOption (API gap). fs2.Chunk has none of the reduce family.
...
class IntReduceBenchmark extends IntInputs {
  ...
  @Benchmark def array_reduce(): Int = arrayInput.reduce(_ + _)
  ...
  @Benchmark def array_reduceLeft(): Int = arrayInput.reduceLeft(_ + _)
  ...
  @Benchmark def array_reduceRight(): Int = arrayInput.reduceRight(_ + _)
  ...
  @Benchmark def array_reduceOption(): Option[Int] = arrayInput.reduceOption(_ + _)
  @Benchmark def ziochunk_reduceOption(): Option[Int] = zioChunkInput.reduceOption(_ + _)

  // reduceLeftOption / reduceRightOption: FArray has neither (API gap)
  ...
  @Benchmark def array_reduceLeftOption(): Option[Int] = arrayInput.reduceLeftOption(_ + _)
  ...
  @Benchmark def array_reduceRightOption(): Option[Int] = arrayInput.reduceRightOption(_ + _)
