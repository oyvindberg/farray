...
class AggregateIntBenchmark extends IntInputs {
  ...
  @Benchmark def kyochunk_max(): Int = kyoChunkInput.max
  ...
  @Benchmark def kyochunk_min(): Int = kyoChunkInput.min
  ...
  @Benchmark def kyochunk_maxBy(): Int = kyoChunkInput.maxBy(x => -x)
  ...
  @Benchmark def kyochunk_minBy(): Int = kyoChunkInput.minBy(x => -x)
  ...
  @Benchmark def kyochunk_sum(): Int = kyoChunkInput.sum
  ...
  @Benchmark def kyochunk_product(): Int = kyoChunkInput.product
