...
class IntSlicingBenchmark extends IntInputs {
  ...
  @Benchmark def array_partition(): (Array[Int], Array[Int]) = arrayInput.partition(_ % 2 == 0)
  ...
  @Benchmark def array_span(): (Array[Int], Array[Int]) = arrayInput.span(_ < size / 2)
  ...
  @Benchmark def array_splitAt(): (Array[Int], Array[Int]) = arrayInput.splitAt(size / 2)
  ...
  @Benchmark def array_distinct(): Array[Int] = arrayInput.distinct
  ...
  @Benchmark def array_grouped(): Int = { var n = 0; arrayInput.grouped(math.max(1, size / 2)).foreach(_ => n += 1); n }
  ...
  @Benchmark def array_sliding(): Int = { var n = 0; arrayInput.sliding(2, 3).foreach(_ => n += 1); n }
