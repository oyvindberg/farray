...
class ShortCircuitIntBenchmark extends IntInputs {
  ...
  @Benchmark def vector_indexWhere(): Int = vectorInput.indexWhere(_ == 5)
  ...
  @Benchmark def vector_find(): Option[Int] = vectorInput.find(_ == 5)
...
class ShortCircuitStrBenchmark extends Inputs {
  ...
  @Benchmark def vector_find(): Option[String] = vectorInput.find(_ == "5")
