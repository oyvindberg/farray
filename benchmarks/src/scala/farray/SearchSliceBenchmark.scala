...
class IntSearchSliceBenchmark extends IntInputs {
  ...
  @Benchmark def array_startsWith(): Boolean = arrayInput.startsWith(Array(0, 1, 2))
  ...
  @Benchmark def array_endsWith(): Boolean = arrayInput.endsWith(Array(size - 3, size - 2, size - 1))
  ...
  @Benchmark def array_segmentLength(): Int = arrayInput.segmentLength(_ < size / 2)
  ...
  @Benchmark def array_lastIndexWhere(): Int = arrayInput.lastIndexWhere(_ == 5)
  ...
  @Benchmark def array_sameElements(): Boolean = arrayInput.sameElements(arraySame)
  ...
  @Benchmark def array_indexOfSlice(): Int = arrayInput.indexOfSlice(arraySlice)
  ...
  @Benchmark def array_lastIndexOf(): Int = arrayInput.lastIndexOf(5)
  ...
  @Benchmark def array_lastIndexOfSlice(): Int = arrayInput.lastIndexOfSlice(arraySlice)
  ...
  @Benchmark def array_containsSlice(): Boolean = arrayInput.containsSlice(arraySlice)
