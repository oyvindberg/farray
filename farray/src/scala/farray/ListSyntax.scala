...
object ListSyntax:
  ...
  final class DoubleCons(private val xs: FArray[Double]) extends AnyVal:
    ...
    def _1: Double = xs.asFBase match
  ...
  final class BooleanCons(private val xs: FArray[Boolean]) extends AnyVal:
    ...
    def _1: Boolean = xs.asFBase match
