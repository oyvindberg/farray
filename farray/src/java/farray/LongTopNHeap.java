...
/** Unboxed top-N heap keyed by a {@code long}. See {@link DoubleTopNHeap} for the scheme; identical but for a
 *  {@code long[]} key array (no per-element boxing). */
public final class LongTopNHeap {
    ...
    private boolean worse(long a, long b) { return largest ? a < b : a > b; }
