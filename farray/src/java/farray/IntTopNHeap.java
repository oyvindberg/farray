...
/** Unboxed top-N heap keyed by an {@code int}. See {@link DoubleTopNHeap} for the scheme; identical but for an
 *  {@code int[]} key array (no per-element boxing). */
public final class IntTopNHeap {
    ...
    private boolean worse(int a, int b) { return largest ? a < b : a > b; }
