...
loop, both paths, spliced into your method at every `flatMap` call site, the way `.fuse` does by
design. And in isolation it was excellent: with the loop and your lambda in one compilation
