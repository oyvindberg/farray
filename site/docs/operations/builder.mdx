...
handicap. One honest caveat lives *under* the win: on the fill loop alone (reference elements),
...
check — so the gap isn't the cast or an allocation (both ruled out by measurement); HotSpot simply
