...
which is brittle, and impossible through a generic signature.
...
Every builder here finalizes to an immutable (`ArrayBuffer` via `toArray`, like the
...
handicap. One caveat lives under the win: on the fill loop alone (reference elements),
