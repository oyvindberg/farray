...
/** The FSet benchmarks' JMH bytecode generator — a parallel of [[GenJmh]] for the FArray suite, pointed at the
  * `setbenchmarks` project's compiled classes so the two suites generate into separate runner source trees. */
